...
public class crearPartido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            crearPartido(fecha, resultado, local, visita);
    ...
    private static void crearPartido(java.lang.String fecha, java.lang.String resultado, int local, int visita) {
        ...
        port.crearPartido(fecha, resultado, local, visita);
    }
}
