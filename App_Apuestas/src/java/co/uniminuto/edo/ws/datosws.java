...
import co.uniminuto.edo.ws.JavonGateways;
import co.uniminuto.edo.ws.InvocationAbstraction;
import co.uniminuto.edo.ws.Utility;
 ...
 * </ul>
 */
public class datosws extends HttpServlet {
    ...
    static {
        METHODS = new HashMap();
        METHODS.put(new Integer(3), new JavonGateways.co_uniminuto_edo_ws_apuestawsverApuestasPago3Gateway());
        METHODS.put(new Integer(6), new JavonGateways.co_uniminuto_edo_ws_apuestawsactualizarApuesta6Gateway());
        METHODS.put(new Integer(1), new JavonGateways.co_uniminuto_edo_ws_apuestawscrearApuesta1Gateway());
        METHODS.put(new Integer(5), new JavonGateways.co_uniminuto_edo_ws_apuestawsconsultaApuesta5Gateway());
        METHODS.put(new Integer(4), new JavonGateways.co_uniminuto_edo_ws_apuestawsverApuestasUsuario4Gateway());
        METHODS.put(new Integer(2), new JavonGateways.co_uniminuto_edo_ws_apuestawsverApuestas2Gateway());
        METHODS.put(new Integer(10), new JavonGateways.co_uniminuto_edo_ws_partidowscrearPartido10Gateway());
        METHODS.put(new Integer(14), new JavonGateways.co_uniminuto_edo_ws_partidowsconsultaPartido14Gateway());
        METHODS.put(new Integer(15), new JavonGateways.co_uniminuto_edo_ws_partidowsactualizarResultado15Gateway());
        METHODS.put(new Integer(11), new JavonGateways.co_uniminuto_edo_ws_partidowsverPartidos11Gateway());
        METHODS.put(new Integer(13), new JavonGateways.co_uniminuto_edo_ws_partidowsverPartidosApostar13Gateway());
        METHODS.put(new Integer(12), new JavonGateways.co_uniminuto_edo_ws_partidowsverPartidosActualizar12Gateway());
        METHODS.put(new Integer(19), new JavonGateways.co_uniminuto_edo_ws_usuariowsconsultaSaldo19Gateway());
        METHODS.put(new Integer(16), new JavonGateways.co_uniminuto_edo_ws_usuariowsregistro16Gateway());
        METHODS.put(new Integer(17), new JavonGateways.co_uniminuto_edo_ws_usuariowssumarValor17Gateway());
        METHODS.put(new Integer(18), new JavonGateways.co_uniminuto_edo_ws_usuariowsrestarValor18Gateway());
        METHODS.put(new Integer(7), new JavonGateways.co_uniminuto_edo_ws_equipowscrearEquipo7Gateway());
        METHODS.put(new Integer(8), new JavonGateways.co_uniminuto_edo_ws_equipowsverEquipos8Gateway());
        METHODS.put(new Integer(9), new JavonGateways.co_uniminuto_edo_ws_equipowsconsultarEquipo9Gateway());
    }
